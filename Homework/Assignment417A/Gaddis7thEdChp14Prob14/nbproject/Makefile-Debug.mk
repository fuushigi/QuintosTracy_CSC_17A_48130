...
${OBJECTDIR}/_ext/870914629/ParkedCar.o: ../../source/ParkedCar.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/870914629/ParkedCar.o ../../source/ParkedCar.cpp

${OBJECTDIR}/_ext/870914629/ParkingMeter.o: ../../source/ParkingMeter.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/870914629
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/870914629/ParkingMeter.o ../../source/ParkingMeter.cpp

${OBJECTDIR}/_ext/870914629/ParkingTicket.o: ../../source/ParkingTicket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/870914629
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/870914629/ParkingTicket.o ../../source/ParkingTicket.cpp

${OBJECTDIR}/_ext/870914629/PoliceOfficer.o: ../../source/PoliceOfficer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/870914629
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/870914629/PoliceOfficer.o ../../source/PoliceOfficer.cpp

${OBJECTDIR}/_ext/870914629/main.o: ../../source/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/870914629
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/870914629/main.o ../../source/main.cpp
