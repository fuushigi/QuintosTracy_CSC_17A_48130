...
void question1Audpol();
void question1Audpo2();
void question1Audpo3();
void question1Audpo4();
void question1Audpo5();
void question1Audpo6();
void question1Audpo7();
void question1Audpo8();
void question1Audpo9();
void question1Audpo10();
void question1Audpol1();
void question1Audpol2();
void question1Audpol3();
void question1Audpol4();
void question1Audpol5();
...
void initialize(player[]); //initializes the player information
void input(player[]);  //function for player to input their information after bonus/or after Wrong answers   
void print(player[]); //function to print player information at end game
void winlosefunction();//functions with structures
void winprint(); //functions with structures

void  DisplayNumbers(int *Nbr[], int r, int c); //Pointers with arrays //displays the pay out structure
...
void question1Audpol5() //created an object to produce an audience poll life-line
{
        ...
        question15poll.D = 2; //answer D is 1%
